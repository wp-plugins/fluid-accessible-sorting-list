...
function FluidAccessibleSortingList_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_FluidAccessibleSortingList') ) {
        wp_register_script('InfusionAll', ( get_bloginfo('wpurl') . '/wp-content/plugins/FluidAccessibleSortingList/lib/InfusionAll.js'));
        wp_enqueue_script('InfusionAll');

        wp_register_script('FluidAccessibleSortingList', ( get_bloginfo('wpurl') . '/wp-content/plugins/FluidAccessibleSortingList/lib/FluidAccessibleSortingList.js'));
        wp_enqueue_script('FluidAccessibleSortingList');

        wp_register_style('FluidAccessibleSortingList_css', ( get_bloginfo('wpurl') . '/wp-content/plugins/FluidAccessibleSortingList/lib/FluidAccessibleSortingList.css'));
